...
# Used the walkthrough video no. 6 (Waypoint updater partial walkthrough)
import rospy
...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        #For the message structure refer to video no. 6 (Waypoint updater partial walkthrough) at 7m50s
        ...
        #For the math associated with this refer to video no. 6 (Waypoint updater partial walkthrough) at 10m0s
    ...
    def traffic_cb(self, msg):
        ...
        #print("Bhat : waypoint_updater, insdie traffic_cb " + str(self.traffic_waypoint))
