...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        #print("Bhat : tl_detector: image_cb : begin")
        self.has_image = True
        ...
        if self.state != state:
            self.state_count = 0
            self.state = state
            #print("Bhat : tl_detector: image_cb : 1")
        elif self.state_count >= STATE_COUNT_THRESHOLD:
            self.last_state = self.state
            light_wp = light_wp if state == TrafficLight.RED else -1
            self.last_wp = light_wp
            self.upcoming_red_light_pub.publish(Int32(light_wp))
            #print("Bhat : tl_detector: image_cb : 2")
        else:
            self.upcoming_red_light_pub.publish(Int32(self.last_wp))
            #print("Bhat : tl_detector: image_cb : 3")
        self.state_count += 1
        #print("Bhat : tl_detector: image_cb : end")
    ...
    def get_light_state(self, light):
        ...
        """
        #print("Bhat : tl_detector : " + str(light.state))
        return light.state
